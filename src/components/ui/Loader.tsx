      ...
      {!isLoaderFinished && (
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-light tracking-[0.6em] text-white select-none whitespace-nowrap logo-glow">
                INTERIOR
              </h1>
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="w-48 md:w-64 h-[1px] bg-white/5 relative overflow-hidden mt-2">
                  <motion.div
                    initial={{ x: "-100%" }}
                    animate={{ x: "100%" }}
                    transition={{
